...
@section('headersubcontent')
    <div class="col s10 m6 l6">
        <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{ $companyInfo->name }} | Şirket Düzenle</span></h5>
    </div>
            ...
            <div class="card-content">
                <div class="row">
                    <div class="col s12" id="account">
                        ...
                        <form method="POST" action="{{ route('company.update',['id'=>$companyInfo->id]) }}" enctype="multipart/form-data" >
                            @csrf
                            @if(session('status'))
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="col s12 m12">
                                    <div class="row">
                                        <div class="col s6 input-field">
                                            <input id="name" name="name" type="text" class=" @error('name') is-invalid @enderror" value="{{ $companyInfo->name }}"
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="website" name="website" type="text" class=" @error('website') is-invalid @enderror" value="{{ $companyInfo->website }}"
                                                   data-error=".website">
