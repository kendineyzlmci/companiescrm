            ...
            <div class="card-content">
                <div class="row">
                    <div class="col s12" id="account">
                        ...
                        <form method="POST" action="{{ route('address.update',['id'=>$companyAddressInfo->id]) }}" enctype="multipart/form-data" >
                            @csrf
                            @if(session('status'))
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="col s12 m12">
                                    <div class="row">
                                        <div class="col s12 input-field">
                                            <input id="address" name="address" type="text" class=" @error('address') is-invalid @enderror" value="{{ $companyAddressInfo->addresses['address'] }}"
                                                   data-error=".address">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="lat" name="lat" placeholder="" type="text" class="validate @error('lat') is-invalid @enderror" value="{{ $companyAddressInfo->addresses['lat'] }}"
                                                   data-error=".lat">
                                        ...
                                        <div class="col s6 input-field">
                                            <input id="lon" name="lon" placeholder="" type="text" class="validate @error('lon') is-invalid @enderror" value="{{ $companyAddressInfo->addresses['lon'] }}"
                                                   data-error=".lon">
                                        ...
                                        <input type="hidden" name="zoom" id="zoom" value="{{ $companyAddressInfo->addresses['zoom'] }}">
                                        <div class="col s12">
...
@section('js')
    ...
    <script>
        var ibbMAP = new SehirHaritasiAPI({mapFrame:"mapFrame",apiKey:"5568225db28d43b5a9e9f916eca99589"}, function(){
            ...
            ibbMAP.Map.Goto({
                lat: {{ $companyAddressInfo->addresses['lat'] }},
                lon: {{ $companyAddressInfo->addresses['lon'] }},
                zoom: {{ $companyAddressInfo->addresses['zoom'] }},
                effect: true
            });
        });
    </script>
